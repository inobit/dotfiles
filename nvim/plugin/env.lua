local function setup_nvim_venv()
  ...
  local venv_path = data_path .. path_sep .. "venv"
  ...
  if not venv_exists then
    ...
    vim.notify("creating a virtual environment...", vim.log.levels.INFO)
    local create_cmd = "uv venv --python 3.12 " .. vim.fn.shellescape(venv_path .. path_sep .. ".venv")
...
_, vim.g.python3_host_prog = setup_nvim_venv()
