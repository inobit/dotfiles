return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<F7>", function() dap.step_into() end, opts "Debug step into")
    vim.keymap.set("n", "<F8>", function() dap.step_over() end, opts "Debug step over")
    vim.keymap.set("n", vim.fn.has "win32" == 1 and "<S-F8>" or "<F20>", function() dap.step_out() end, opts "Debug step out")
